...
/** Form screen: FlightSort */
export const FlightSortScreen: React.FC<{ navigation: any }> = ({ navigation }) => {
  ...
  return (
    <Screen>
      <Text style={[typography.h1 as any, { marginBottom: spacing.sm }]}>Sort Flights</Text>
