...
/** Form screen: AddTraveler */
export const AddTravelerScreen: React.FC<{ navigation: any }> = ({ navigation }) => {
  ...
  return (
    <Screen>
      <Text style={[typography.h1 as any, { marginBottom: spacing.sm }]}>Add New Traveler</Text>
