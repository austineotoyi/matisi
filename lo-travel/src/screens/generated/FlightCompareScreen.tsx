...
/** List screen: FlightCompare */
export const FlightCompareScreen: React.FC<{ navigation: any }> = () => (
  <Screen scroll={false}>
    <Text style={[typography.h1 as any, { marginBottom: spacing.md }]}>Compare Flights</Text>
    <FlatList
      data={DATA}
